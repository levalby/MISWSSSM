...
if __name__ == "__main__":
    ...
    setting_matrix = [[1.1, 0.6, 1.6, 1], [1.2, 0.7, 1.5, 1], [1.3, 0.8, 1.4, 1],
                      [1.4, 0.9, 1.3, 1], [1.5, 1.2, 0.8, 1], [1.4, 1.3, 1.7, 1],
                      [1.3, 1.3, 0.4, 1], [1.2, 1.4, 0.6, 1], [1.1, 1.5, 0.8, 1],]
